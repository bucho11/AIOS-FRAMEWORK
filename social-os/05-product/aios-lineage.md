...
| File Placement Router — route by the question you'll ask later | → | The numbered flow `1 Ideas → 2 Drafts → 3 Approved → 4 Published` | **Drive** |
...
- ❌ `_index.md` discipline — too much upkeep for a non-technical owner
